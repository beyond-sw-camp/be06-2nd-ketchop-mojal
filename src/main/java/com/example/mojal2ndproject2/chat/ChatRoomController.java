...
//        });
    ...
    public void addMessage(@PathVariable String roomId, @RequestBody ChatMessage chatMessage, @AuthenticationPrincipal CustomUserDetails customUserDetails) { //포스트id, 룸id,
